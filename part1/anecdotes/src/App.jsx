...
const App = () => {
  ...
  const anecdotesVotes = new Array(8).fill(0);
  ...
  const bestAnecdote = votes.indexOf(mostVotedAnecdote)
  ...
  return (
    <div>
      ...
      <button onClick={() => setSelected(RandomNumber(8))}>next anecdote</button>
      </div>
      <div>
